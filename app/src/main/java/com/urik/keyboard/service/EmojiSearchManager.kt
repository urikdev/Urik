...
data class EmojiAnnotations(val language: String, val emojis: Map<String, List<String>>)
...
constructor(
    ...
    private fun loadAnnotationsForLanguage(languageCode: String): EmojiAnnotations? = try {
