...
constructor(
    ...
    suspend fun finalize(swipePath: List<SwipeDetector.SwipePoint>, rawPointCount: Int): List<WordCandidate> =
        withContext(scoringDispatcher) {
            gestureActive = false
            tickerJob?.cancel()
