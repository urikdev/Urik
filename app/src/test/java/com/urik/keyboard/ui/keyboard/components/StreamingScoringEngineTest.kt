...
class StreamingScoringEngineTest {
    ...
    private val qwertyKeyPositions = mapOf(
        'q' to PointF(30f, 50f), 'w' to PointF(80f, 50f), 'e' to PointF(130f, 50f),
        'r' to PointF(180f, 50f), 't' to PointF(230f, 50f), 'y' to PointF(280f, 50f),
        'u' to PointF(330f, 50f), 'i' to PointF(380f, 50f), 'o' to PointF(430f, 50f),
        'p' to PointF(480f, 50f),
        'a' to PointF(40f, 130f), 's' to PointF(90f, 130f), 'd' to PointF(140f, 130f),
        'f' to PointF(190f, 130f), 'g' to PointF(240f, 130f), 'h' to PointF(290f, 130f),
        'j' to PointF(340f, 130f), 'k' to PointF(390f, 130f), 'l' to PointF(440f, 130f),
        'z' to PointF(90f, 210f), 'x' to PointF(140f, 210f), 'c' to PointF(190f, 210f),
        'v' to PointF(240f, 210f), 'b' to PointF(290f, 210f), 'n' to PointF(340f, 210f),
