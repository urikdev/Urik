...
class UserWordBigramDaoTest {
    ...
    @Test
    fun `incrementBigram inserts new bigram`() = runTest {
    ...
    @Test
    fun `incrementBigram increments existing bigram`() = runTest {
    ...
    @Test
    fun `incrementBigramBy inserts with amount`() = runTest {
    ...
    @Test
    fun `incrementBigramBy adds to existing frequency`() = runTest {
        val timestamp = System.currentTimeMillis()
    ...
    @Test
    fun `getPredictions returns ordered by frequency`() = runTest {
        val timestamp = System.currentTimeMillis()
    ...
    @Test
    fun `getPredictions respects limit`() = runTest {
        val timestamp = System.currentTimeMillis()
    ...
    @Test
    fun `getPredictions is language-scoped`() = runTest {
        val timestamp = System.currentTimeMillis()
    ...
    @Test
    fun `clearLanguage removes all bigrams for language`() = runTest {
        val timestamp = System.currentTimeMillis()
    ...
    @Test
    fun `clearAll removes all bigrams`() = runTest {
        val timestamp = System.currentTimeMillis()
