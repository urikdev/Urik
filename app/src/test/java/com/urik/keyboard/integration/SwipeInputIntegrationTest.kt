...
class SwipeInputIntegrationTest {
    ...
    @Test
    fun `valid swipe word does not trigger highlight`() = runTest(testDispatcher) {
    ...
    @Test
    fun `valid swipe word has correct word state`() = runTest(testDispatcher) {
    ...
    @Test
    fun `invalid swipe word triggers highlight`() = runTest(testDispatcher) {
    ...
    @Test
    fun `invalid swipe word generates suggestions`() = runTest(testDispatcher) {
    ...
    @Test
    fun `spell check suggestions are dictionary-aware`() = runTest(testDispatcher) {
    ...
    @Test
    fun `swipe invalid word then learn prevents highlight`() = runTest(testDispatcher) {
        ...
        assertTrue(
            "Unlearned word should be highlighted",
            (beforeResult as ProcessingResult.Success).shouldHighlight
        )
    ...
    @Test
    fun `learned swipe word appears in future suggestions`() = runTest(testDispatcher) {
    ...
    @Test
    fun `swipe method recorded in learning metadata`() = runTest(testDispatcher) {
        val word = "swipedword"
    ...
    @Test
    fun `word candidate scoring uses frequency data`() = runTest(testDispatcher) {
    ...
    @Test
    fun `learned words boost candidate confidence`() = runTest(testDispatcher) {
    ...
    @Test
    fun `empty swipe word handled gracefully`() = runTest(testDispatcher) {
    ...
    @Test
    fun `very long swipe word processed without error`() = runTest(testDispatcher) {
    ...
    @Test
    fun `swipe with special characters handled`() = runTest(testDispatcher) {
        val result = textInputProcessor.processWordInput("hello!", InputMethod.SWIPED)
    ...
    @Test
    fun `learning swipe word invalidates spell check cache`() = runTest(testDispatcher) {
    ...
    @Test
    fun `swipe processing produces consistent results`() = runTest(testDispatcher) {
        val word = "hello"
    ...
    @Test
    fun `complete swipe flow - valid word no confirmation`() = runTest(testDispatcher) {
        val validWord = "hello"
    ...
    @Test
    fun `complete swipe flow - invalid word with confirmation`() = runTest(testDispatcher) {
    ...
    @Test
    fun `blacklisted words excluded from spell check suggestions`() = runTest(testDispatcher) {
        val suggestions = spellCheckManager.generateSuggestions("helo", 5)
    ...
    @Test
    fun `blacklisted words excluded from common words for swipe`() = runTest(testDispatcher) {
    ...
    @Test
    fun `re-learning blacklisted word removes from blacklist`() = runTest(testDispatcher) {
